...
let g:ycm_python_binary_path = '/home/lizhuo/anaconda3/envs/tensorflow/bin/python'
...
func SetTitle() 
    ...
    if &filetype == 'sh' 
        ...
        call append(line(".")+1, "\# Author: lizhuo") 
        call append(line(".")+2, "\# mail: zhuo01.li@samsung.com") 
